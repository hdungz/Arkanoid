...
public class AssetsManager {
    ...
    public static void loadAssets() {
        ...
        loadImages("level1", "/com/arkanoid/ChooseLevel/level1.png");
        loadImages("level2", "/com/arkanoid/ChooseLevel/level2.png");
        loadImages("level3", "/com/arkanoid/ChooseLevel/level3.png");
        loadImages("level4", "/com/arkanoid/ChooseLevel/level4.png");
        loadImages("level5", "/com/arkanoid/ChooseLevel/level5.png");
        loadImages("level6", "/com/arkanoid/ChooseLevel/level6.png");
        loadImages("level7", "/com/arkanoid/ChooseLevel/level7.png");
        loadImages("level8", "/com/arkanoid/ChooseLevel/level8.png");
        loadImages("level9", "/com/arkanoid/ChooseLevel/level9.png");
        loadImages("level10", "/com/arkanoid/ChooseLevel/level10.png");
        loadImages("level11", "/com/arkanoid/ChooseLevel/level11.png");
        loadImages("level12", "/com/arkanoid/ChooseLevel/level12.png");
        loadImages("level13", "/com/arkanoid/ChooseLevel/level13.png");
        loadImages("level14", "/com/arkanoid/ChooseLevel/level14.png");
        loadImages("level15", "/com/arkanoid/ChooseLevel/level15.png");
        loadImages("level16", "/com/arkanoid/ChooseLevel/level16.png");
        loadImages("level17", "/com/arkanoid/ChooseLevel/level17.png");
        loadImages("level18", "/com/arkanoid/ChooseLevel/level18.png");
        loadImages("level19", "/com/arkanoid/ChooseLevel/level19.png");
        loadImages("level20", "/com/arkanoid/ChooseLevel/level20.png");
